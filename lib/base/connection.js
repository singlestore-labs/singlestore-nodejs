...
class BaseConnection extends EventEmitter {
  constructor(opts) {
    ...
    if (!this.config.isServer) {
      ...
      handshakeCommand.on('end', () => {
        ...
        // Set session variables before emitting connect event
        if (this.config.sessionVariables) {
  ...
  _setSessionVariables(callback) {
    ...
    for (const [sessionVar, value] of Object.entries(
      ...
      sessionVarsQuery += `SESSION ${sessionVar} = ${this.escape(value)},`;
    }
